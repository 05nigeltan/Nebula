...
- `shm_predictions.csv`
- `rail_predictions.csv` — copied from the new ensemble output
- `acv_predictions.csv`
...
`write_up.md` includes the promoted ensemble and distinguishes local validation from the
user-reported submission scores. Further subsystem documentation is in `documentation/`.
